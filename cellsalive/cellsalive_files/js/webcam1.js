...
var DELAY = 10;		//Delay between images in minutes
			//legitimate values: 1,2,3,4,5,6,10,12,15,20,30

var IMGNAME = "mel";	//first part of image file names
			//i.e., mel1000.gif => "mel"

var TOTALFRAMES = 145;  //number of frames in the sequence
			//i.e., from 1000 - 1144 => 145 

var DIRNAME = "cam1/"	//directory of images
			//i.e., "/cam1", "cam2/" (note: the / is important)

var REPEATHOURS = 24;	//Number of hours before sequence repeats
